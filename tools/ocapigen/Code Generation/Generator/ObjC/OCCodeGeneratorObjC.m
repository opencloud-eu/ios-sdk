...
- (void)addCopyrightHeaderToSegment:(OCCodeFileSegment *)segment
{
	...
	[segment addLine:@"// Copyright (C) %@ OpenCloud GmbH, 2025 ownCloud GmbH. All rights reserved.", year];
	[segment addLine:@"//"];
	[segment addLine:@""];
	[segment addLine:@"/*"];
	[segment addLine:@" * Copyright (C) %@ OpenCloud GmbH, 2025 ownCloud GmbH.", year];
	[segment addLine:@" *"];
