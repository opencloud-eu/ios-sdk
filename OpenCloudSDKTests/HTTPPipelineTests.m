...
- (void)testSimpleHTTPRequest
{
	...
	[pipeline startWithCompletionHandler:^(id sender, NSError *error) {
		...
		if ((request = [OCHTTPRequest requestWithURL:[NSURL URLWithString:@"https://demo.opencloud.eu/status.php"]]) != nil)
		{
...
- (void)testPartitionIsolation
{
	...
	[pipeline startWithCompletionHandler:^(id sender, NSError *error) {
		...
		request1 = [OCHTTPRequest requestWithURL:[NSURL URLWithString:@"https://demo.opencloud.eu/status.php"]];
		request2 = [OCHTTPRequest requestWithURL:[NSURL URLWithString:@"https://demo.opencloud.eu/status.php"]];
...
- (void)testSignals
{
	...
	[pipeline startWithCompletionHandler:^(id sender, NSError *error) {
		...
		[pipeline attachPartitionHandler:partition1 completionHandler:^(id sender, NSError *error) {
			...
			request3 = [OCHTTPRequest requestWithURL:[NSURL URLWithString:@"https://demo.opencloud.eu/status.php"]];
	...
	[pipeline startWithCompletionHandler:^(id sender, NSError *error) {
		...
		[pipeline attachPartitionHandler:partitionHandler completionHandler:^(id sender, NSError *error) {
			...
			for (NSUInteger i=0; i<requestCount; i++)
			{
				...
				request = [OCHTTPRequest requestWithURL:[NSURL URLWithString:@"https://demo.opencloud.eu/status.php"]];
				request.ephermalResultHandler = ^(OCHTTPRequest *request, OCHTTPResponse *response, NSError *error) {
					XCTAssert(error==nil);
	...
	[pipeline startWithCompletionHandler:^(id sender, NSError *error) {
		...
		[pipeline attachPartitionHandler:partitionHandler completionHandler:^(id sender, NSError *error) {
			...
			for (NSUInteger i=0; i<requests; i++)
			{
				...
				request = [OCHTTPRequest requestWithURL:[NSURL URLWithString:@"https://download.opencloud.eu/community/opencloud-10.1.0.tar.bz2"]];
				request.ephermalResultHandler = ^(OCHTTPRequest *request, OCHTTPResponse *response, NSError *error) {
					if ([error isOCErrorWithCode:OCErrorRequestCancelled])
					{
						cancelledRequests++;
...
- (void)testSessionDroppedRequests
{
	...
	if ((fakeRequest = [OCHTTPRequest requestWithURL:[NSURL URLWithString:@"https://demo.opencloud.eu/status.php"]]) != nil)
	{
...
- (void)testHostSimulationSupport
{
	...
	[pipeline startWithCompletionHandler:^(id sender, NSError *error) {
		...
		if ((requestSimulated = [OCHTTPRequest requestWithURL:[NSURL URLWithString:@"https://demo.opencloud.eu/status.php?"]]) != nil)
		{
		...
		if ((requestPassthrough = [OCHTTPRequest requestWithURL:[NSURL URLWithString:@"https://demo.opencloud.eu/status.php"]]) != nil)
		{
...
- (void)testProgress
{
	...
	[pipeline startWithCompletionHandler:^(id sender, NSError *error) {
		...
		[pipeline attachPartitionHandler:partitionHandler completionHandler:^(id sender, NSError *error) {
			...
			if ((request = [OCHTTPRequest requestWithURL:[NSURL URLWithString:@"https://download.opencloud.eu/community/opencloud-10.1.0.tar.bz2"]]) != nil)
			{
