...
{
	[self _runPreparationTestsForURL:[NSURL URLWithString:@"https://demo.opencloud.eu/"] completionHandler:^(NSURL *url, OCBookmark *bookmark, OCIssue *issue, NSArray<OCAuthenticationMethodIdentifier> *supportedMethods, NSArray<OCAuthenticationMethodIdentifier> *preferredAuthenticationMethods) {
...
- (void)testSetupPreparationInvalidURL
{
	...
	[self _runPreparationTestsForURL:[NSURL URLWithString:@"https://nosuch.opencloud/"] completionHandler:^(NSURL *url, OCBookmark *bookmark, OCIssue *issue, NSArray<OCAuthenticationMethodIdentifier> *supportedMethods, NSArray<OCAuthenticationMethodIdentifier> *preferredAuthenticationMethods) {
		XCTAssert(issue.issues.count==1, @"1 issue found");
...
{
	// URL doesn't point to OpenCloud instance

	[self _runPreparationTestsForURL:[NSURL URLWithString:@"https://opencloud.eu/"] completionHandler:^(NSURL *url, OCBookmark *bookmark, OCIssue *issue, NSArray<OCAuthenticationMethodIdentifier> *supportedMethods, NSArray<OCAuthenticationMethodIdentifier> *preferredAuthenticationMethods) {
...
{
	// http://demo.opencloud.eu/ => https://demo.opencloud.eu/

	[self _runPreparationTestsForURL:[NSURL URLWithString:@"http://demo.opencloud.eu/"] completionHandler:^(NSURL *url, OCBookmark *bookmark, OCIssue *issue, NSArray<OCAuthenticationMethodIdentifier> *supportedMethods, NSArray<OCAuthenticationMethodIdentifier> *preferredAuthenticationMethods) {
		XCTAssert(issue.issues.count==2, @"2 issues");
		...
		XCTAssert([issue.issues[1].suggestedURL isEqual:[NSURL URLWithString:@"https://demo.opencloud.eu/"]], @"Redirect suggestedURL is correct");

		XCTAssert (([bookmark.url isEqual:url]) && (bookmark.originURL==nil), @"Bookmark has expected values");

		[issue approve];
		
		XCTAssert (([bookmark.url isEqual:[NSURL URLWithString:@"https://demo.opencloud.eu/"]]) && [bookmark.originURL isEqual:url] && (bookmark.originURL!=nil), @"Bookmark has expected values");
	}];
}
...
{
	// https://goo.gl/dh6yW5 => https://demo.opencloud.eu/
	...
	[self _runPreparationTestsForURL:[NSURL URLWithString:@"https://goo.gl/dh6yW5"] completionHandler:^(NSURL *url, OCBookmark *bookmark, OCIssue *issue, NSArray<OCAuthenticationMethodIdentifier> *supportedMethods, NSArray<OCAuthenticationMethodIdentifier> *preferredAuthenticationMethods) {
		...
		XCTAssert([issue.issues[2].suggestedURL isEqual:[NSURL URLWithString:@"https://demo.opencloud.eu/"]], @"Redirect suggestedURL is correct");
...
{
	// http://bit.ly/2GTa2wD => https://goo.gl/dh6yW5 => https://demo.opencloud.eu/
	...
	[self _runPreparationTestsForURL:[NSURL URLWithString:@"http://bit.ly/2GTa2wD"] completionHandler:^(NSURL *url, OCBookmark *bookmark, OCIssue *issue, NSArray<OCAuthenticationMethodIdentifier> *supportedMethods, NSArray<OCAuthenticationMethodIdentifier> *preferredAuthenticationMethods) {
		...
		XCTAssert([issue.issues[3].suggestedURL isEqual:[NSURL URLWithString:@"https://demo.opencloud.eu/"]], @"Redirect suggestedURL is correct");
...
{
	// https://t.co/JTo2XnbS5G => http://bit.ly/2GTa2wD => https://goo.gl/dh6yW5 => https://demo.opencloud.eu/
	...
	[self _runPreparationTestsForURL:[NSURL URLWithString:@"https://t.co/JTo2XnbS5G"] completionHandler:^(NSURL *url, OCBookmark *bookmark, OCIssue *issue, NSArray<OCAuthenticationMethodIdentifier> *supportedMethods, NSArray<OCAuthenticationMethodIdentifier> *preferredAuthenticationMethods) {
		...
		XCTAssert([issue.issues[6].suggestedURL isEqual:[NSURL URLWithString:@"https://demo.opencloud.eu/"]], @"Redirect suggestedURL is correct");
...
{
	// demo.opencloud.eu is hosted on carmen.opencloud.systems

	[self _runPreparationTestsForURL:[NSURL URLWithString:@"https://carmen.opencloud.systems/"] completionHandler:^(NSURL *url, OCBookmark *bookmark, OCIssue *issue, NSArray<OCAuthenticationMethodIdentifier> *supportedMethods, NSArray<OCAuthenticationMethodIdentifier> *preferredAuthenticationMethods) {
		XCTAssert(issue.issues.count==2, @"2 issues");
		XCTAssert(([issue issuesWithLevelGreaterThanOrEqualTo:OCIssueLevelError].count==1), @"1 error");
...
{
	// NSString *userEnteredURLString = @"https://admin:admin@demo.opencloud.eu"; // URL string retrieved from a text field, as entered by the user.
								...
								completionHandler:^(NSError *error, OCAuthenticationMethodIdentifier authenticationMethodIdentifier, NSData *authenticationData) {
									if (error == nil)
									{
										...
										dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
											...
											// newConnection.bookmark.url = [NSURL URLWithString:@"https://opencloud-io.lan/"];
...
- (void)testConnect
{
	...
	[self _testConnectWithUserEnteredURLString:@"https://admin:admin@demo.opencloud.eu" useAuthMethod:nil preConnectAction:nil connectAction:^(NSError *error, OCIssue *issue, OCConnection *connection) {
...
- (void)testConnectMinimumServerVersion
{
	...
	{
		OCConnection *connection;
		OCBookmark *bookmark = [OCBookmark bookmarkForURL:[NSURL URLWithString:@"https://demo.opencloud.eu"]];
...
- (void)testConnectWithFakedCert
{
	...
	[self _testConnectWithUserEnteredURLString:@"https://admin:admin@demo.opencloud.eu" useAuthMethod:nil preConnectAction:^(OCConnection *connection) {
		// Load and inject fake certificate for demo.opencloud.eu
		...
		[connection.bookmark.certificateStore storeCertificate:[OCCertificate certificateWithCertificateData:fakeCertData hostName:@"demo.opencloud.eu"] forHostname:@"demo.opencloud.eu"];
...
- (void)testConnectAndGetRootList
{
	...
	[self _testConnectWithUserEnteredURLString:@"https://admin:admin@demo.opencloud.eu" useAuthMethod:nil preConnectAction:nil connectAction:^(NSError *error, OCIssue *issue, OCConnection *connection) {
		...
		if (error == nil)
		{
			// connection.bookmark.url = [NSURL URLWithString:@"https://opencloud-io.lan/"];
...
- (void)testConnectAndGetThumbnails
{
	...
	[self _testConnectWithUserEnteredURLString:@"http://admin:admin@demo.opencloud.eu" useAuthMethod:OCAuthenticationMethodIdentifierBasicAuth preConnectAction:nil connectAction:^(NSError *error, OCIssue *issue, OCConnection *connection) {
		OCLog(@"User: %@", connection.loggedInUser.userName);
...
- (void)testCapabilitiesDecoding
{
	...
	XCTAssert([capabilities.productName isEqual:@"OpenCloud"]);
	XCTAssert([capabilities.hostName isEqual:@"opencloud"]);
