...
# RESPONSE --------------------------------------------------------
Method:     GET
URL:        https://demo.opencloud.eu/ocs/v1.php/apps/files_sharing/api/v1/shares
...
<ocs>
 ...
 <data>
  ...
  <element>
   ...
   <url>https://demo.opencloud.eu/s/JSzGhtzHZZRG1Ns</url>
   <mail_send>0</mail_send>
  </element>
 </data>
</ocs>
...
<ocs>
 ...
 <data>
  <element>
   ...
   <url>https://demo.opencloud.eu/s/URRc6Qg3z53YmPL</url>
   <mail_send>0</mail_send>
  </element>
  <element>
   <id>29</id>
   ...
   <name>Public link</name>
   <url>https://demo.opencloud.eu/s/DYKVR0odXmVef2y</url>
   <mail_send>0</mail_send>
  </element>
 </data>
</ocs>
...
# RESPONSE --------------------------------------------------------
Method:     GET
URL:        https://demo.opencloud.eu/ocs/v1.php/apps/files_sharing/api/v1/shares?shared_with_me=true
...
<ocs>
 ...
 <data>
  <element>
   ...
   <share_with_displayname/>
   <name>Public link</name>
   <url>https://demo.opencloud.eu/s/MFvU91PDCvAfzWh</url>
   <mail_send>0</mail_send>
  </element>
 </data>
</ocs>
...
<ocs>
 ...
 <data>
  <element>
   ...
   <share_with_displayname/>
   <name>Public link</name>
   <url>https://demo.opencloud.eu/s/PDCvAfMFvU91zWh</url>
   <mail_send>0</mail_send>
  </element>
 </data>
</ocs>
...
# RESPONSE --------------------------------------------------------
Method:     GET
URL:        https://demo.opencloud.eu/ocs/v1.php/apps/files_sharing/api/v1/remote_shares/pending
...
<ocs>
 ...
 <data>
  <element>
   <id>3</id>
   <remote>https://demo.opencloud.eu</remote>
...
# RESPONSE --------------------------------------------------------
Method:     GET
URL:        https://demo.opencloud.eu/ocs/v1.php/apps/files_sharing/api/v1/remote_shares
...
<ocs>
 ...
 <data>
  ...
  <element>
   ...
   <name>/OpenCloud Manual.pdf</name>
   <owner>test</owner>
   <user>test</user>
   <mountpoint>/OpenCloud Manual (2).pdf</mountpoint>
   <accepted>1</accepted>
