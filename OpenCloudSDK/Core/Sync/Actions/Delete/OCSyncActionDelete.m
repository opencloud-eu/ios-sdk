...
- (OCCoreSyncInstruction)handleResultWithContext:(OCSyncContext *)syncContext
{
	...
	else if (event.error != nil)
	{
		...
		/*
			...
			https://demo.opencloud.eu/remote.php/dav/files/demo/Photos/: didCompleteWithError=Error Domain=NSURLErrorDomain Code=-1009 "The Internet connection appears to be offline." UserInfo={NSUnderlyingError=0x1c4653470 {Error Domain=kCFErrorDomainCFNetwork Code=-1009 "(null)" UserInfo={_kCFStreamErrorCodeKey=50, _kCFStreamErrorDomainKey=1}}, NSErrorFailingURLStringKey=https://demo.opencloud.eu/remote.php/dav/files/demo/Photos/, NSErrorFailingURLKey=https://demo.opencloud.eu/remote.php/dav/files/demo/Photos/, _kCFStreamErrorDomainKey=1, _kCFStreamErrorCodeKey=50, NSLocalizedDescription=The Internet connection appears to be offline.} [OCConnectionQueue.m:506|FULL]
		*/
