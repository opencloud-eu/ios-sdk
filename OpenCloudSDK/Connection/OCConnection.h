...
@property(readonly,strong,nullable,nonatomic) NSString *serverProductName; //!< After connecting, the product name of the server ("productname"), f.ex. "OpenCloud".
...
@property(readonly,strong,nullable,nonatomic) NSString *serverLongProductVersionString; //!< After connecting, a string summarizing the product, edition and version, f.ex. "OpenCloud Community 10.0.8.5"
