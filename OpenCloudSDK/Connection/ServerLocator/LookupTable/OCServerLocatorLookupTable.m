...
+ (void)load
{
	...
	[OCExtensionManager.sharedExtensionManager addExtension:[OCExtension serverLocatorExtensionWithIdentifier:OCServerLocatorIdentifierLookupTable locations:@[] metadata:@{
		OCExtensionMetadataKeyDescription : @"Locate server via lookup table. Keys can match against the beginning (f.ex. \"begins:bob@\"), end (f.ex. \"ends:@opencloud.eu\") or regular expression (f.ex. \"regexp:\")"
