...
- (OCIPCNotificationName)coreUpdateNotificationName
{
	...
	{
		_coreUpdateNotificationName = [[NSString alloc] initWithFormat:@"com.opencloud.occore.update.%@", self.uuid.UUIDString];
	}
...
- (OCIPCNotificationName)bookmarkAuthUpdateNotificationName
{
	...
	{
		_bookmarkAuthUpdateNotificationName = [[NSString alloc] initWithFormat:@"com.opencloud.bookmark.auth-update.%@", self.uuid.UUIDString];
	}
...
+ (OCIPCNotificationName)bookmarkAuthUpdateNotificationName
{
	return (@"com.opencloud.bookmark.auth-update");
}
