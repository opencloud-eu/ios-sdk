...
static OCIPCNotificationName OCIPCNotificationNameClassSettingsUserPreferencesChanged = @"com.opencloud.class-settings.user-preferences.changed";
...
- (NSMutableDictionary<OCClassSettingsIdentifier, NSDictionary<OCClassSettingsKey, id> *> *)mainDictionary
{
	...
	if ((mainDictionaryReadOnly = [OCAppIdentity.sharedAppIdentity.userDefaults dictionaryForKey:@"org.opencloud.user-settings"]) != nil)
	{
...
{
	[OCAppIdentity.sharedAppIdentity.userDefaults setObject:mainDictionary forKey:@"org.opencloud.user-settings"];
}
